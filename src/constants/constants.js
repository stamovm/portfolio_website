...
export const TimeLineData = [
  { year: 2012, text: 'MS Degree in Computer Science' },
  { year: 2019, text: 'Web Chat Technical Support Agent' },
  { year: 2021, text: 'Learning Web Development' },
]
